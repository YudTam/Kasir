...
Route::get('/menu/cold-coffe', function () {
    return view('menu.cold-coffe');
});

Route::get('/menu/hot-coffe', function () {
    return view('menu.hot-coffe');
});

Route::get('/menu/cold-drinks', function () {
    return view('menu.cold-drinks');
});

Route::get('/menu/hot-drinks', function () {
    return view('menu.cold-drinks');
});
